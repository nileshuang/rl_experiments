...
def main(n_iterations=20,
    ...
    train_metrics = {}
    #train_metrics['rl_losses'] = rl_losses
    #train_metrics['rewards'] = rewards
    # train_metrics['sample_smiles'] = ''
    train_metrics['duration'] = duration
    # at end of training, generate library for model assessment
    ...
    # perform cursory assessment of generated library
